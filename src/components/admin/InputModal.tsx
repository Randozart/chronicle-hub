...
export default function InputModal({
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            // Focus input after a slight delay to allow render
    ...
    }, [isOpen, value]); // value dependency needed for closure in handleSubmit
        ...
        <div style={{
            ...
            >
                ...
                <div>
                    ...
                    <input
                        ref={inputRef}
                        className="form-input" // Uses your global CSS class
