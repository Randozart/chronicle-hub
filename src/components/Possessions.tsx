...
const ItemDisplay = ({ 
    ...
    return (
        <div className="inventory-item card" style={{ 
            ...
            <div style={{ marginTop: 'auto', display: 'flex', gap: '0.5rem', flexWrap: 'wrap', paddingTop: '0.5rem', borderTop: '1px dashed var(--border-light)' }}>
                {isEquipable && (
                    <button 
...
export default function Possessions({ 
    ...
    // @ts-ignore
    const layoutMode = settings.componentConfig?.equipmentLayout || 'grid';
    const isList = layoutMode === 'list';

    // Styles for switching layouts
        ...
        <div className="possessions-container">
            ...
            {expandedSlots.length > 0 && (
                <>
                    ...
                    <div className={`equipment-grid ${isList ? 'mode-list' : ''}`} style={isList ? listStyle : gridStyle}>
            ...
            {groups.map(group => (
                <div key={group} style={{ marginBottom: '2rem' }}>
                    ...
                    <div className={`inventory-grid ${isList ? 'mode-list' : ''}`} style={isList ? listStyle : gridStyle}>
