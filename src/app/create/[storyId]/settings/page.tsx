        ...
        <div className="admin-editor-col" style={{ maxWidth: '900px', margin: '0 auto' }}>            
            ...
            <div style={{ borderBottom: '1px solid #444', paddingBottom: '2rem', marginBottom: '2rem' }}>
                ...
                <div className="form-row">
                    <div className="form-group"><label className="form-label">Cover Image URL</label><input value={form.coverImage || ''} onChange={e => handleChange('coverImage', e.target.value)} className="form-input" /></div>
                    <div className="form-group"><label className="form-label">Tags</label><input defaultValue={form.tags?.join(', ')} onBlur={e => handleArrayChange('tags', e.target.value)} className="form-input" /></div>
                </div>
            </div>
            ...
            <div className="special-field-group" style={{ borderColor: '#e5c07b' }}>
                ...
                <p className="special-desc">Map engine features to your qualities.</p>
                ...
                <div className="form-row" style={{ marginTop: '1.5rem' }}>
                    <div className="form-group"><label className="form-label">Action Counter ID</label><input value={form.actionId} onChange={e => handleChange('actionId', e.target.value)} className="form-input" placeholder="$actions" /></div>
                    <div className="form-group"><label className="form-label">Player Name ID</label><input value={form.playerName} onChange={e => handleChange('playerName', e.target.value)} className="form-input" placeholder="$player_name" /></div>
                    <div className="form-group"><label className="form-label">Player Portrait ID</label><input value={form.playerImage} onChange={e => handleChange('playerImage', e.target.value)} className="form-input" placeholder="$player_portrait" /></div>
                </div>
            ...
            <div className="special-field-group" style={{ borderColor: '#61afef' }}>
                ...
                {form.useActionEconomy && (
                    <div className="form-row">
                        ...
                        <div className="form-group" style={{flex:1}}>
                            <label className="form-label">Regen Time (Min)</label>
                ...
                <div className="form-group" style={{ marginTop: '1rem', borderTop: '1px dashed #444', paddingTop: '1rem' }}>
                     <SmartArea 
                        ...
                        subLabel="Applied if a deck doesn't specify its own cost."
                    />
                </div>
                ...
                <label className="special-label" style={{ color: '#c678dd' }}>Visuals</label>
                 ...
                 {form.enableTitle && (
                    <div className="form-group" style={{ marginTop: '0.5rem' }}>
                        <input value={form.titleQualityId || ''} onChange={e => handleChange('titleQualityId', e.target.value)} className="form-input" placeholder="$title_quality" />
                    </div>
                 )}
        ...
        <div className="special-field-group" style={{ borderColor: '#98c379' }}>
            ...
            <div style={{ display: 'grid', gap: '0.5rem' }}>
             ...
             <div style={{ display: 'flex', gap: '10px', marginTop: '1rem' }}>
                <input value={newKey} onChange={e => setNewKey(e.target.value)} placeholder="$key" className="form-input" style={{ flex: 1 }} />
                <input value={newVal} onChange={e => setNewVal(e.target.value)} placeholder="val" className="form-input" style={{ flex: 1 }} />
                <button onClick={handleAdd} className="save-btn" style={{width:'auto'}}>Add</button>
             </div>
        </div>
    );
}
