...
import InstrumentEditor from './InstrumentEditor'; // The complex UI
...
export default function InstrumentMainForm({ initialData, onSave, onDelete, onDuplicate, storyId, guardRef }: Props) {
    ...
    return (
        <div className="h-full flex flex-col relative" style={{ paddingBottom: '80px' }}>
            {/* The Original Editor UI, now controlled by this form */}
            <InstrumentEditor 
                data={form}
                onChange={(newData) => setData(newData)}
                onInsertIntoTrack={undefined} // Hidden in Admin Mode
            />
