...
export default function DeckMainForm({ initialData, onSave, onDelete, onDuplicate, storyId, qualityDefs, guardRef }: Props) {
    ...
    // Helper for the "Saved" property which is historically a string "True"/"False" in some data models, 
    // but we should treat it as boolean in the UI.
                ...
                <div className="form-row">
                    <div className="form-group" style={{ flex: 1 }}>
                        ...
                        <select 
                            ...
                            style={{ height: '40px' }} // Match SmartArea height
                        >
